!function (e, t) {
    ...
    function E(e) {
        ...
        this.editor = e, this.$elem = o('<div class="w-e-menu"><i class="w-e-icon-pencil2"><i/></div>'), this.type = "droplist", this._active = !1, this.droplist = new l(this, {
            ...
            list: [{
                ...
                $elem: o('<i style="color:#ff0000;" class="w-e-icon-pencil2"></i>'),
                value: "#ff0000"
            }, {
    ...
    function y(e) {
        ...
        this.editor = e, this.$elem = o('<div class="w-e-menu"><i class="w-e-icon-paint-brush"><i/></div>'), this.type = "droplist", this._active = !1, this.droplist = new l(this, {
            ...
            list: [{
                ...
                $elem: o('<i style="color:#ff0000;" class="w-e-icon-paint-brush"></i>'),
                value: "#ff0000"
            }, {
    ...
    u.prototype = {
        ...
        constructor: B, onClick: function (e) {
            ...
            if (!L.isIE()) return void("BLOCKQUOTE" === i ? t.cmd.do("formatBlock", "<P>") : t.cmd.do("formatBlock", "<BLOCKQUOTE>"));
        ...
        constructor: T, _alert: function (e, t) {
            ...
            if (e && e.length) {
                var n = this.editor, i = n.config, o = i.uploadImgServer, c = i.uploadImgShowBase64,
                    ...
                    p = i.uploadImgHeaders || {}, f = i.uploadImgHooks || {}, g = i.uploadImgTimeout || 3e3,
                    m = i.withCredentials;
                null == m && (m = !1);
    ...
    H.prototype = {
        constructor: H, _initConfig: function () {
            ...
            null == i ? (a = o("<div></div>"), s = o("<div></div>"), d = n.children(), n.append(a).append(s), a.css("background-color", "#f1f1f1").css("border", "1px solid #ccc"), s.css("border", "1px solid #ccc").css("border-top", "none").css("height", "800px")) : (a = n, s = o(i), d = s.children()), l = o("<div></div>"), l.attr("contenteditable", "true").css("width", "100%").css("height", "100%"), d && d.length ? l.append(d) : l.append(o("<p><br></p>")), s.append(l), a.addClass("w-e-toolbar"), s.addClass("w-e-text-container"), s.css("z-index", r), l.addClass("w-e-text");
